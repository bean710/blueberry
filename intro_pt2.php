...
echo   "
        ...
        In our example, half of the potential losses would mean <b>4</b> (8/2 = 4), and twice the price would mean <b>2</b> (1*2 = 2). As 4 is larger than 2, it would make sense to buy the insurance in this case.<br><br>
      ";
