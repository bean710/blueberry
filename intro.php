...
$dbopts = parse_url("postgres://osaxydmvbsxvdn:a4abf5a952a69a534ef4a7c6593519f6eba0f16cfd9dc216dd4e6b700610143f@ec2-52-207-124-89.compute-1.amazonaws.com:5432/d6s648r538kctj");
...
$constr = "host=${dbhost} port=${dbport} dbname=${dbname} user=${dbuser} password=${dbpass}";

$conn = pg_connect($constr);

$insert_dat = array("id"=>"DEFAULT", "foo"=>"bananas");
pg_insert($conn, 'test', $insert_dat)
*/
...
$connectionParams = array(
  'url' => 'postgres://osaxydmvbsxvdn:a4abf5a952a69a534ef4a7c6593519f6eba0f16cfd9dc216dd4e6b700610143f@ec2-52-207-124-89.compute-1.amazonaws.com:5432/d6s648r538kctj',
);

$conn = DriverManager::getConnection($connectionParams);
$sql = "INSERT INTO test(id, foo) VALUES(DEFAULT, :string)";

$stmt = $conn->prepare($sql);
$stmt->bindValue("string", "bananas");
$stmt->execute();
