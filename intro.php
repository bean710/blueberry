...
//stuff here
    ...
    //TODO: Remove next line
      ...
      */
      ...
      echo "Thank you for playing <b>Angry Blueberries!</b> This is a classic slingshot video game, played using only your mouse. In this game, you shoot blueberries at pineapples and each time you hit a pineapple, you can harvest it. Each pineapple is worth $$cpp, so your goal should be to harvest as many pineapples as you can! You will receive a bonus payment according to the number of pineapples you harvest throughout the game.<br><br>
        ...
        On each level, there are <b>7 pineapples</b>. If you hit all 7 pineapples in a level, you earn <b>3 extra pineapples</b>!<br><br>
        ...
        For now, your <b>total blueberry-budget</b> amounts to <b>$tot</b> blueberries. For each level, you will have $per blueberries that you can fire. Other participants were assigned a total blueberry-budget of <b>" . ($tot == 30 ? 150 : 30) . "</b> blueberries (i.e. <b>" . ($per == 3 ? 15 : 3) . "</b> per level). You might have more or less blueberries for the real experiment. We will inform you about any changes concerning your budget after the practice rounds. <br><br>
        You have to <b>shoot at least one blueberry per level</b>. You can move on from a level after shooting the first berry--just click the 'next' button near the bottom right of the screen. You do not have to use all of your berries on each level. Any unused berries will carry over to future levels. Once you use up your shots, you won't be able to use any more until you move to the next level. <br><br>
        The <b>scoreboard</b> in the top right of the screen will tell you how many berries you have fired on each round, how many berries remain for the game, how many pineapples you've harvested on the level, and how many pineapples you've harvested overall.<br><br>
        ";
