...
function initialize()
{
	...
	// Setup insurance buy button click Events
...
function getDataParameters()
{
	...
	if (debug){
		var outObj = {
			...
			"lberries": levelBerries,
			"lpoints": levelPoints,
			"trace": tracePointsArr,
			"traceTimes": traceTimesArr
		}
		console.log(outObj);

		var futureObj = {
			"bought_ins": levelBoughtIns,
			"ins_dat": insDatFull[levelNumber]
		}
