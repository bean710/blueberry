...
echo "<br>";
echo "It's time to see how many pineapples you earned! <br>Your pineapple field started with $startingNum pineapples, but you lost " . ($losses ? $losses : "0") . " pineapples from uninsured disasters. <br>
